...
public class ELKUtils {
	...
	/**
	 * Constructs the document that needs to be injected to Elasticsearch using Map
	 * interface. Can also use a POJO to construct the json
	 * 
	 * @author Amuthan Sakthivel Mar 20, 2021
	 * @param testname
	 * @param status
	 */
